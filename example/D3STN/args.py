...
parser.add_argument("--d_model", type=int, default=128, help="d_proj+d_sect*2")
parser.add_argument("--d_proj", type=int, default=32)
parser.add_argument("--d_sect", type=int, default=32)
parser.add_argument("--d_adaptive", type=int, default=32)
