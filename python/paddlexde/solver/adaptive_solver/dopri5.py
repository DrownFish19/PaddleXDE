...
_DORMAND_PRINCE_SHAMPINE_TABLEAU = _ButcherTableau(
    alpha=paddle.to_tensor([1 / 5, 3 / 10, 4 / 5, 8 / 9, 1., 1.], dtype=paddle.float64),
    beta=[
        ...
        paddle.to_tensor([19372 / 6561, -25360 / 2187, 64448 / 6561, -212 / 729], dtype=paddle.float64),
        paddle.to_tensor([9017 / 3168, -355 / 33, 46732 / 5247, 49 / 176, -5103 / 18656], dtype=paddle.float64),
        paddle.to_tensor([35 / 384, 0, 500 / 1113, 125 / 192, -2187 / 6784, 11 / 84], dtype=paddle.float64),
    ],
    c_sol=paddle.to_tensor([35 / 384, 0, 500 / 1113, 125 / 192, -2187 / 6784, 11 / 84, 0], dtype=paddle.float64),
